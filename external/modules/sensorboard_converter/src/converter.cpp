...
void Converter::config(lms::type::ModuleConfig *config) {
...
void Converter::parse_config_linear(lms::type::ModuleConfig *cfg) {
    c.linear.factor = cfg->get<float>("factor", 1.0f);
    c.linear.offset = cfg->get<float>("offset", 0.0f);
}

void Converter::parse_config_ir_curve(lms::type::ModuleConfig *cfg) {

	//TODO
}

void Converter::parse_config_dual_linear(lms::type::ModuleConfig *cfg) {
...
void Converter::parse_config_mapping(lms::type::ModuleConfig *cfg) {
